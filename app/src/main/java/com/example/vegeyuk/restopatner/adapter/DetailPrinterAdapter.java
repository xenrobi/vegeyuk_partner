...
public class DetailPrinterAdapter extends BaseAdapter{
    ...
    public DetailPrinterAdapter(Context context, List<Menu> data){
        super();
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        if(view == null){
            ...
            view = layoutInflater.inflate(R.layout.single_row_struk_item_list,null);
